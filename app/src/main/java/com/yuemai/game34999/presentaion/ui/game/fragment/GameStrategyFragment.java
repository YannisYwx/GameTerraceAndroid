...
import com.yuemai.game34999.presentaion.ui.game.adapter.GameStrategyAdapter;
 ...
 * @description :
 */
public class GameStrategyFragment extends BaseListMvpFragment {
    GameStrategyAdapter mAdapter;
    List datas;
    ...
    public void refreshContentView(View contentView) {
        mAdapter = new GameStrategyAdapter(datas);
