...
import com.yuemai.game34999.presentaion.ui.game.holder.GameStrategyHolder;
 ...
 * @description :
 */
public class GameStrategyAdapter extends BaseRecyclerAdapter {
    public GameStrategyAdapter(List dataList) {
        super(dataList);
    }
    ...
    protected RecyclerView.ViewHolder getCommonHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext().getApplicationContext(), R.layout.item_game_strategy, null);
        return new GameStrategyHolder(view);
    }
