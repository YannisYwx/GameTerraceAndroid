 ...
 * @description :
 */
public class TestDownloadXiaoMiActivity extends AbstractMvpLoadPagerActivity<TestDownloadPresenter> implements TestDownloadContract.View {
    ...
    public static void start(android.content.Context context) {
        context.startActivity(new Intent(context, TestDownloadXiaoMiActivity.class));
    }
