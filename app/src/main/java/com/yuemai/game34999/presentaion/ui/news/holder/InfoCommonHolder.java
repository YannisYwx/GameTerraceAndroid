...
/**
 * @author : Yannis.Ywx
 * @createTime : 2017/11/24  19:03
 * @email : 923080261@qq.com
 * @description :带图片的资讯item
 */
public class InfoCommonHolder extends BaseRecycleHolder<News> {
    ...
    public InfoCommonHolder(View itemView, boolean isShowType) {
        super(itemView);
    ...
    protected void refreshViewHolder(News data) {
        ...
        ImageLoader.loadNewsItemImage(mContext, data.getNewsIcon(), mImageView);
