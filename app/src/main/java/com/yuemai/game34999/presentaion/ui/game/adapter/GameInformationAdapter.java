...
import com.yuemai.game34999.presentaion.ui.game.holder.GameInformationHolder;
 ...
 * @description :
 */
public class GameInformationAdapter extends BaseRecyclerAdapter {

    public GameInformationAdapter(List dataList) {
        super(dataList);
    }
    ...
    protected RecyclerView.ViewHolder getCommonHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext().getApplicationContext(), R.layout.item_game_information, null);
        return new GameInformationHolder(view);
    }
