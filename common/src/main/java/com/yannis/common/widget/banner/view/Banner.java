...
public class Banner extends FrameLayout {
    ...
    private void setData() {
        ...
        if (adapter == null) {
            ...
            datas.addAll(imageUrls);
            adapter = new BannerPagerAdapter(datas, viewPager);
...
//    }
    ...
    public class BannerPagerAdapter extends LoopViewPagerAdapter {

        public BannerPagerAdapter(ArrayList urls, ViewPager viewPager) {
            super(urls, viewPager);
        }

        @Override
        protected View getItemView(final int position, Object url) {
            View view = imageViews.get(position);
            if (listener != null) {
                view.setOnClickListener(new OnClickListener() {
                    @Override
        ...
        @Override
        protected void onLoopPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        @Override
        protected void onLoopPageSelected(int position) {
        ...
        @Override
        protected void onLoopPageScrollStateChanged(int state) {
            if (mOnPageChangeListener != null) {
    ...
    public void onPageScrollStateChanged(int state) {
        ...
        switch (state) {
            ...
            case 1:
                //start Sliding
                Logger.e("onPageScrollStateChanged-------- count = " + count + " currentItem = " + currentItem);
