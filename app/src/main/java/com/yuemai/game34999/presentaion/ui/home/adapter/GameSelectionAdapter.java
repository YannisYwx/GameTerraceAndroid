...
/**
 * @author : Yannis.Ywx
 * @createTime : 2017/9/25  14:36
 * @email : 923080261@qq.com
 * @description :
 */
public class GameSelectionAdapter extends CommonAdapter{
    public GameSelectionAdapter(Context context, int layoutId, List dataList) {
