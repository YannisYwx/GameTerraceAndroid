...
import com.yuemai.game34999.presentaion.ui.game.adapter.GameInformationAdapter;
 ...
 * @description :
 */
public class GameInformationFragment extends BaseListMvpFragment {
    List datas;
    GameInformationAdapter mAdapter;
    ...
    public void refreshContentView(View contentView) {
        mAdapter = new GameInformationAdapter(datas);
