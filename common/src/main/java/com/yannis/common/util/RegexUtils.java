...
public class RegexUtils {
     ...
     * 车牌号码
     */
    private static final Pattern PATTERN_VEHICLE_NO = Pattern.compile("^[\u4e00-\u9fa5]{1}[a-zA-Z]{1}[a-zA-Z_0-9]{5}$");
    ...
    public static boolean checkVehicleNo(String vehicleNo) {
        return PATTERN_VEHICLE_NO.matcher(vehicleNo).find();
